    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card-box">
                ...
                <form method="post" action="{{route('createCurrency')}}">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input id="branch_name" type="text" class="form-control @error('currency_name') is-invalid @enderror" name="currency_name" value="{{ old('currency_name') }}"  autocomplete="currency_name" autofocus>
                            @error('currency_name')
                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
