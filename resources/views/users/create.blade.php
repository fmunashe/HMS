...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <div class="card-box">
                <h4 class="card-title">New User Registration<a href="{{route('users')}}" class="btn btn-success btn-rounded pull-right"><i class="fa fa-backward"></i> Back</a></h4>
                <form method="post" action="{{route('createUser')}}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <button class="btn btn-success form-control" type="submit">{{ __('Register New User') }}</button>
                        </div>
                    </div>
                </form>
            </div>
