...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-4 col-md-4 col-lg-4 col-xl-3">
            <a href="add-role.html" class="btn btn-success btn-block"><i class="fa fa-plus"></i> Add Roles</a>
            <div class="roles-menu">
                <ul>
                    ...
                    <li><a href="#">Authoriser</a></li>
                    <li><a href="#">Inputter</a></li>
                    <li><a href="#">Auditor</a></li>
                    <li><a href="#">Stock Clerk</a></li>
